...
describe MedicionesController do
  fixtures :all
  render_views
  ...
  it "create action should redirect when model is valid" do
    ...
    post :create
    response.should redirect_to(medicion_url(assigns[:medicion]))
  end
  ...
  it "destroy action should destroy model and redirect to index action" do
    ...
    response.should redirect_to(mediciones_url)
    Medicion.exists?(medicion.id).should be_false
  end
end
